...
public class Partie {
    ...
    public void attribuerCouleursAuxJoueurs() {
        ...
        //donne rouge ou jaune comme couleur aux joueurs
        Random rand = new Random();
        boolean quellecouleur;
        quellecouleur = rand.nextBoolean();

        //attribution aleatoire des couleurs 
    ...
    // Cette methode va créer la grille, les joueurs et va leur associer une couleur, et placer les trous noirs aléatoirement
    public void initialiserPartie() {

        grilleJeu = new Grille(); // création grille 

// attribution des 21 jetons rouge et jaune aux joueurs
        for (int t = 0; t <= 20; t++) {
       ...
       // int Des=0;
        ...
        while (compteur<5){// on veux placer 5 trous noirs
     ...
     */
    //cette methode regarde quel joueur est en train de jouer, 
    //le premier joueur est le J1 et permet de coder l'alterance des tours des joueurs.
    ...
    public void debuterPartie() {
        // Débuter partie gère tous les tours de la partie jusqu'à detection de la partie.

        attribuerCouleursAuxJoueurs();

        initialiserPartie();

        //On a decide du joueur qui commence aléatoirement.
        Random rand = new Random();
        boolean futurJoueur;
        ...
        while (fin == false) { // tant que la partie n'est pas finie : 
            ...
            if (choix == 1) {
                ...
                // On vérifie s'il choisit un chiffre parmi les choix proposés
                ...
                boolean validation = grilleJeu.colonneRemplie(colonne); // Verifie si la colonne est pleine
            ...
            } else if (choix == 2) { // le joueur choisit de récupérer un jeton 

                int recupColonne;
                int recupLigne;

                // On choisit les coordonnées du jeton que l'on veut 
                ...
                if (nbrGagnant != 0) {
                    ...
                    } else { // s'il y a une égalité après tassement de la grille, 
                        //c'est le joueur qui n'a pas provoqué le tassement de la grille qui gagne
